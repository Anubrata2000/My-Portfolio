        ...
        <div className="space-y-10 md:pl-20">
          ...
          <div>
            ...
            <div className="space-y-2">
              <a href="mailto:chatterjeeanubrata386@gmail.com" className="block text-xl md:text-2xl font-bold text-white hover:text-[var(--accent)] transition-colors break-words">
                chatterjeeanubrata386@gmail.com
              </a>
              <a href="tel:+919434977524" className="block text-xl md:text-2xl font-bold text-gray-300 hover:text-[var(--accent)] transition-colors">
                +91 94349 77524
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="mailto:chatterjeeanubrata386@gmail.com" className="w-12 h-12 flex items-center justify-center rounded-xl bg-white/5 border border-white/10 hover:border-[var(--accent)] hover:bg-[var(--accent)] hover:text-white transition-all duration-300 group">
              ...
              <a href="https://linkedin.com/in/anubrata-chatterjee-9a588b246" target="_blank" rel="noopener noreferrer" className="w-12 h-12 flex items-center justify-center rounded-xl bg-white/5 border border-white/10 hover:border-[var(--accent)] hover:bg-[var(--accent)] hover:text-white transition-all duration-300 group">
              ...
              <a href="https://github.com/Anubrata2000" target="_blank" rel="noopener noreferrer" className="w-12 h-12 flex items-center justify-center rounded-xl bg-white/5 border border-white/10 hover:border-[var(--accent)] hover:bg-[var(--accent)] hover:text-white transition-all duration-300 group">
                <svg className="w-6 h-6 text-gray-400 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
